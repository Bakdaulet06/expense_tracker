...
const inputClass =
    "w-full rounded-2xl px-4 md:px-5 py-3 md:py-4 text-sm md:text-base outline-none transition-all"
...
export default function ExpenseEdit() {
    ...
    return (
        <div className="flex-1 flex flex-col h-screen" style={{ backgroundColor: "var(--bg-primary)" }}>
            ...
            <div className="flex-1 overflow-y-auto px-6 md:px-14 pb-6 md:py-10">
                    ...
                    <div className="flex items-center gap-2 md:gap-3 mt-0.5 md:mt-1">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="w-7 h-7 md:w-9 md:h-9 rounded-full flex items-center justify-center transition-colors"
                            >
                                <IconCalendar />
                            </button>
                ...
                >
                    ...
                    <div className="col-span-1 md:col-span-2 pt-1 md:pt-2 flex flex-col md:flex-row md:gap-5">
                        ...
                        <button
                            className="w-full md:w-[300px] font-semibold text-sm md:text-base py-4 md:px-14 rounded-2xl shadow-lg transition-all active:scale-[0.98] cursor-pointer"
                            style={{
                                backgroundColor: "var(--card)",
                                color: "var(--text-primary)"
                            }}
